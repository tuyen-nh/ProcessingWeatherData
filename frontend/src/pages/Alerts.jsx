  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between fade-up">
        <p className="label">{t('alerts.count', { count: rows.length })}</p>
      ...
      {rows.length === 0 && <Empty label={t('alerts.empty')} />}
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="display text-lg text-ink tracking-tight">
                  {t(`alertType.${a.alert_type}`, a.alert_type)}
              ...
              <div className="text-right shrink-0">
                ...
                <div className="label mt-0.5">
                  {t('alerts.thr')} {a.threshold_exceeded} · {Math.round(ratio * 100)}%
                </div>
              </div>
            </div>
          )
